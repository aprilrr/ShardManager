...
#[derive(Debug)]
pub struct ShardManagerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ShardManagerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ShardManager processing");
    
    let mut processor = ShardManagerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ShardManagerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ShardManagerProcessor::new(false);
